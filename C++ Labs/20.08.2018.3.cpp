...
//• вывод на экран информации о товаре, чье количество наибольшее в магазине;
//• вывод на экран информации о самом дешевом товаре в магазине.
...
int main()
{
    ...
    while(Menu)
    {
        ...
        cout<<"2.Информация о товаре с самым большим количеством."<<endl;
        cout<<"3.Информация о самом дешёвом товаре."<<endl;
        cout<<"Ваш выбор: ";
        do
        {
            cin>>Select;
        ...
        case 2:
        {
            ...
            cout<<"Информация о товаре, с самым большим количеством: "<<endl;
        ...
        case 3:
        {
            ...
            cout<<SPISOK[pmin].TOVAR<<" начальная цена - "<<SPISOK[pmin].TSENA<<" стоимость товара - "<<SPISOK[pmin].STOIM<<" в количестве: "<<SPISOK[pmin].KOL<<endl;
