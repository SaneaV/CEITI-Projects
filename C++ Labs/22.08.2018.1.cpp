...
• Список книг изданных заданным издательством;
• Список книг заданного автора, изданных до 2000 года.*/
...
int main()
{
    ...
    while(!FinishProgram)
    {
        cout<<"1. Список книг изданных заданным издательством..."<<endl;
        cout<<"2. Список книг заданного автора, изданных до 2000 года."<<endl;
        cout<<"Ваш выбор: ";
        do
        {
            cin>>Selection;
        ...
        case 1:
        {
            ...
            for(int i=0; i<AmountOfBooks; i++)
            {
                if(strcmp(PublishName,B[i].PublishName)==0)
                {
