//Напишите программу, которая в последовательности целых чисел определяет количество четных чисел, кратных шести.
    ...
    case 1:
        {
            ...
            cout<<"Количество чисел кратных шести: "<<Numberof<<endl;
            break;
        }
    case 2:
        {
