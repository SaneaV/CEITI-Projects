//Напишите программу, которая в последовательности целых чисел определяет количество положительных чисел, кратных двенадцати .
    ...
    case 1:
        {
            while(Finish)
            {
                while(abs(A[i]>30000))
                {
                    cout<<"Введите число: ";
                    cin>>A[i];
                    if(A[i]>=0 and A[i]%12==0 and A[i]!=0) k++;
                }
                n++;
                if (A[i]==0)
                {
            ...
            cout<<"Количество положительных чисел, кратных 12: "<<k<<endl;
            break;
        }
    case 2:
        {
